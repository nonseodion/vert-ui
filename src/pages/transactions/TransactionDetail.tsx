  ...
  return (
    <Wrapper>
      <div className="py-[23px] px-4 lg:py-[56px] lg:px-[87px]">
        ...
        <div className="mt-[30px] px-5 h-[95px] bg-[#F3FFF1] rounded-[4px] flex items-center space-x-[18px]">
        ...
        <ul className="mt-[62px] w-fit mx-0 lg:mx-auto flex flex-col space-y-8">
